 ...
 return (
   ...
   <View style={styles.textContainer}>
      ...
      <ScrollView>
        ...
        <View style={styles.imagem}>
          <Shoes img={require('../../assets/colar/colarlua.png')}cost="R$1.769,00"  onClick={()=> alert('Detail')}>
          Colar Lua e estrela Brilhante
          </Shoes>
          <Shoes img={require('../../assets/colar/colarprata.png')}cost="R$1.430,00"  onClick={()=> alert('Detail')}>
         Colar de Prata
          </Shoes>
        </View>

        <View style={styles.imagem}>
          <Shoes img={require('../../assets/colar/ColarRaízes.png')}cost="R$1.800,00"  onClick={()=> alert('Detail')}>
          Colar Raízes Amor
          </Shoes>
          <Shoes img={require('../../assets/colar/colarshine.png')} cost="R$1.169,00" onClick={()=> alert('Detail')}>
         Colar Shine
          </Shoes>
        </View>
