 ...
 return (
   <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.imagem}>
          <Shoes img={require('../../assets/bracelete/BraceleteExplosão.png')}cost="R$1.200,90"  onClick={()=> alert('Detail')}>
            Bracelete Estrelar
          </Shoes>
          <Shoes img={require('../../assets/bracelete/BraceleteInfinito.png')}cost="R$1.009,00" onClick={()=> alert('Detail')}>
          Bracelete Infinito Assimétrico
          </Shoes>
        </View>

        <View style={styles.imagem}>
          <Shoes img={require('../../assets/bracelete/BraceleteMarvel.png')}cost="R$1.329,00"  onClick={()=> alert('Detail')}>
          Braselete Marvel Vingadores
          </Shoes>
          <Shoes img={require('../../assets/bracelete/BraceleteOuro.png')}cost="R$1.529,00"  onClick={()=> alert('Detail')}>
         Bracelete Crie & Combine
          </Shoes>
        </View>

        <View style={styles.imagem}>
          <Shoes img={require('../../assets/bracelete/BraceletePavé.png')}cost="R$1.529,00"  onClick={()=> alert('Detail')}>
          Braselete Pavé
          </Shoes>
          <Shoes img={require('../../assets/bracelete/BraceleteRigido.png')}cost="R$1.649,00"  onClick={()=> alert('Detail')}>
