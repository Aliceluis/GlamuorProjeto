 ...
 return (
   ...
   <View style={styles.textContainer}>      
      ...
      <ScrollView>
        ...
        <View style={styles.imagem}>
          <Shoes img={require('../../assets/anel/aneldelicada.png')}cost="R$ 1.190,00"   onClick={()=> navigation.navigate('Detail') }>
            Anel Delicada Brilhante
          </Shoes>
          <Shoes img={require('../../assets/anel/anelpetala.png')}cost="R$190,00"  onClick={()=> navigation.navigate('Detail') }>
          Anel Petela    
           </Shoes>
        </View>

        <View style={styles.imagem}>
          <Shoes img={require('../../assets/anel/anelinfinito.png')}cost="R$190,00"   onClick={()=> navigation.navigate('Detail') }>
          Anel Infinito
          </Shoes>
          <Shoes img={require('../../assets/anel/aneldepavé.png')}cost="R$190,00"   onClick={()=> navigation.navigate('Detail') }>
          Anel Princes
          </Shoes>
        </View>

        <View style={styles.imagem}>
          <Shoes img={require('../../assets/anel/anelyoueme.png')}cost="R$190,00"   onClick={()=> navigation.navigate('Detail') }>
          Anel de Coração
          </Shoes>
          <Shoes img={require('../../assets/anel/anelsolitario.png')}cost="R$190,00"   onClick={()=> navigation.navigate('Detail') }>
          Anel you & Me
          </Shoes>
        </View>
